        ...
        <div className="bg-surface-900/80 backdrop-blur-xl border border-surface-700/50 rounded-2xl p-8 animate-scale-in">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link href="#" className="text-brand-400 hover:text-brand-300">Forgot password?</Link>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-surface-700 text-surface-300 hover:bg-surface-800/50 transition-colors text-sm">
